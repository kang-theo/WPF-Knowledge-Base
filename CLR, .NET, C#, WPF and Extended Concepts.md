...
┌───────────────┐     ┌───────────────┐     ┌───────────────┐
│   .NET 5+     │─────►│    .NET Core   │─────►│     MAUI      │
│ （Cross-platform）  │     │ （Cross-platform Foundation） │     │ （Cross-platform UI）  │
└───────────────┘     └───────────────┘     └───────────────┘
       ▲                    ▲                        ▲
       │                    │                        │
┌───────────────┐     ┌───────────────┐     ┌───────────────┐
│ .NET Framework│     │    ASP.NET    │     │    Xamarin    │
│ （Windows-only）│─────►│ （Web Development）  │─────►│ （Mobile Development）  │
└───────────────┘     └───────────────┘     └───────────────┘
       ▲                    ▲                        ▲
       │                    │                        │
┌───────────────┐     ┌───────────────┐     ┌───────────────┐
│     CLR       │─────►│    CTS/MIL    │─────►│     JIT       │
│ （Runtime Core） │     │ （Type System/Intermediate Code）│ （Just-In-Time Compilation）   │
└───────────────┘     └───────────────┘     └───────────────┘
       ▲                    ▲                        ▲
       │                    │                        │
┌───────────────┐     ┌───────────────┐     ┌───────────────┐
│     C#        │─────►│     WPF       │─────►│    UWP        │
│ （Programming Language）   │     │ （Windows UI） │     │ （Universal Windows App）│
└───────────────┘     └───────────────┘     └───────────────┘
```  
